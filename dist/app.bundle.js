...
/***/ function(module, exports, __webpack_require__) {
	...
	var _people = __webpack_require__(299);
	...
	(0, _jquery2.default)('<h1>People</h1>').appendTo('body');
	...
	try {
	  for (var _iterator = _people2.default[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var person = _step.value;

	    (0, _jquery2.default)('<li></li>').text(person).appendTo(ul);
	  }
	} catch (err) {
